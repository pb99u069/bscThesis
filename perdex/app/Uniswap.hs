...
import qualified Swap                                as Uniswap
import qualified Plutus.PAB.Effects.Contract.Builtin as Builtin
import           Wallet.Emulator.Types               (Wallet (..), walletPubKey)
import qualified Reserve.OnChain                     as Reserve

data UniswapContracts =
      Init
    | UniswapStart
    | UniswapUser Uniswap.Uniswap -- value of type Uniswap (which is an AssetClass) is the result of UniswapStart 
...
-- link between this API and the real Contracts
...
-- change here to distribute only a certain amount to other wallets
